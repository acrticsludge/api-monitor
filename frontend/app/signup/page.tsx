...
const highlights = [
  {
    ...
    desc: "5 monitors, pinged every 5 minutes. Get notified the instant something goes down.",
  },
  {
    icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    desc: "2-ping confirmation before alerting — no false positives. Push, Discord, Slack, and email.",
  },
  {
    icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    desc: "0–100 health score with anomaly detection catches degradation before it becomes an outage.",
  },
  {
    icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    title: "Incident Reports & RCA",
    desc: "Auto-generated post-mortems after every outage with root cause analysis and confidence scores.",
  },
  {
    icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    desc: "Shareable uptime page for your users. No configuration needed.",
  },
];
...
export default function SignupPage() {
  ...
  const background = (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute inset-0 opacity-0 dark:opacity-100 bg-[radial-gradient(ellipse_70%_60%_at_30%_0%,rgba(0,255,135,0.07),transparent)]" />
        <div
      ...
      >
        ...
        >
          <div className="relative inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#00cc6a] dark:bg-[#00d294] mb-6 shadow-[0_0_40px_rgba(0,204,106,0.4)] dark:shadow-[0_0_40px_rgba(0,255,135,0.5)]">
            ...
            <svg className="w-8 h-8 text-black relative z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
          ...
          <p className="text-neutral-500 dark:text-neutral-400 text-sm mt-3 leading-relaxed" style={{ fontFamily: "'Geist Mono', monospace" }}>
            We sent a link to{" "}
            <span className="text-[#00cc6a] dark:text-[#00d294] font-medium">{email}</span>
          </p>
          <p className="text-neutral-400 dark:text-neutral-600 text-xs mt-1" style={{ fontFamily: "'Geist Mono', monospace" }}>
  ...
  return (
    <div
      className="min-h-screen bg-[#f8f8f8] dark:bg-[#080808]"
      style={{ fontFamily: "'Geist', sans-serif" }}
    >
      {background}
      ...
      >
        {/* ── Left panel ── */}
        <div className="hidden lg:flex flex-col justify-center px-16 xl:px-24 w-1/2 border-r border-black/[0.06] dark:border-white/[0.04]">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2.5 mb-14">
            <div className="w-8 h-8 rounded-lg bg-[#00cc6a] dark:bg-[#00d294] flex items-center justify-center shadow-[0_0_16px_rgba(0,204,106,0.35)] dark:shadow-[0_0_16px_rgba(0,255,135,0.35)]">
          ...
          {/* Headline */}
          <p
            className="text-[11px] tracking-[0.18em] uppercase text-[#00cc6a] dark:text-[#00d294] font-medium mb-3"
            style={{ fontFamily: "'Geist Mono', monospace" }}
          >
            API Monitor
          </p>
          <h1 className="text-4xl xl:text-5xl font-extrabold tracking-tight text-[#080808] dark:text-white leading-tight mb-4">
            Know before<br />your users do.
          </h1>
          <p
            className="text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed mb-12 max-w-sm"
            style={{ fontFamily: "'Geist Mono', monospace" }}
          >
            Pulse watches your APIs around the clock and alerts you the moment anything breaks — with the context you need to fix it fast.
          </p>
          ...
          <div className="space-y-5">
            {highlights.map((h) => (
              <div key={h.title} className="flex items-start gap-3.5">
                <div className="shrink-0 w-7 h-7 rounded-lg bg-[#00cc6a]/10 dark:bg-[#00d294]/10 border border-[#00cc6a]/20 dark:border-[#00d294]/20 flex items-center justify-center text-[#00cc6a] dark:text-[#00d294]">
                  {h.icon}
                </div>
                <div>
                  <p className="text-sm font-semibold text-[#080808] dark:text-white">
                    {h.title}
                  </p>
                  <p
                    className="text-xs text-neutral-500 dark:text-neutral-500 mt-0.5 leading-relaxed"
                    style={{ fontFamily: "'Geist Mono', monospace" }}
                  >
                    {h.desc}
                  </p>
          ...
          <div className="mt-12 inline-flex items-center gap-2">
            <span
              className="text-[10px] tracking-[0.15em] uppercase text-neutral-400 dark:text-neutral-600"
              style={{ fontFamily: "'Geist Mono', monospace" }}
            >
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-16">
          ...
          <Link href="/" className="flex items-center gap-2 mb-10 lg:hidden">
            <div className="w-7 h-7 rounded-lg bg-[#00cc6a] dark:bg-[#00d294] flex items-center justify-center shadow-[0_0_14px_rgba(0,204,106,0.35)]">
              <svg className="w-3.5 h-3.5 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <span className="text-sm font-bold tracking-[0.08em] uppercase text-[#080808] dark:text-white">Pulse</span>
          </Link>

          <div className="w-full max-w-sm">
            <div className="mb-7">
              <p
                className="text-[11px] tracking-[0.14em] uppercase text-[#00cc6a] dark:text-[#00d294] mb-1.5 font-medium"
                style={{ fontFamily: "'Geist Mono', monospace" }}
              >
                &gt; new account
                <span className="cursor-blink ml-0.5">_</span>
            ...
            <div className="relative bg-white dark:bg-[#0f0f0f] border border-black/[0.08] dark:border-white/[0.08] rounded-2xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.08)] dark:shadow-[0_0_60px_rgba(0,0,0,0.5)]">
              ...
              <div className="px-6 pb-6 text-center">
                <p className="text-xs text-neutral-500" style={{ fontFamily: "'Geist Mono', monospace" }}>
                  ...
                  <Link
                    href="/login"
                    className="text-[#00cc6a] dark:text-[#00d294] hover:text-[#00b560] dark:hover:text-white font-medium transition-colors duration-150"
                  >
                    Sign in
                  </Link>
                </p>
